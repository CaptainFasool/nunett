...
// InspectorContainer returns detailed information about a Docker container.
func (c *Client) InspectorContainer(ctx context.Context, id string) (types.ContainerJSON, error) {
...
func (c *Client) FollowLogs(ctx context.Context, id string) (stdout, stderr io.Reader, err error) {
	cont, err := c.InspectorContainer(ctx, id)
	if err != nil {
...
func (c *Client) GetOutputStream(
	...
	cont, err := c.InspectorContainer(ctx, containerID)
	if err != nil {
